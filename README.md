...
char pass[] = "izsfo_1305";   // your network password
WiFiClient  client;

unsigned long myChannelNumber = 2711832;
const int ChannelField = 1;
const char * myWriteAPIKey = "XVAUD8QPONVNP2HN";
...
```
# CIRCUIT DIAGRAM:
![image](https://github.com/user-attachments/assets/989f5b85-0c60-40e3-886b-72af127fc2c5)

# OUTPUT:
![ldr](https://github.com/user-attachments/assets/2f305bba-0104-4b36-9432-5ac2940f12c5)
